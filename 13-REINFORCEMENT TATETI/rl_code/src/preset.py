...
schedule_params.improve_steps = TrainingSteps(<Enter_Training_Steps>)
schedule_params.steps_between_evaluation_periods = EnvironmentSteps(<Enter_Environment_Steps>)
schedule_params.evaluation_steps = EnvironmentEpisodes(<Enter_Evaluation_Steps>)
